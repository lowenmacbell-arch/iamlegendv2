...
async function handleMessages(sock, messageUpdate) {
    // DEBUG: Log total commands loaded
    console.log('📦 [DEBUG] Total commands loaded:', commandHandler.commands.size);
    ...
    try {
        ...
        // Command detection already done above; reuse `command` and `usedPrefix`
        ...
        // DEBUG: Command found and will be executed
        console.log('🚀 [DEBUG] Executing command:', command.command);
